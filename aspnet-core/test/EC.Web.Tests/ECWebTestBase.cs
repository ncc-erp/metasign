...
{
    public abstract class ECWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ECWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ECWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ECDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ECDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ECDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ECDbContext, Task<T>> func)
        {
            T result;
